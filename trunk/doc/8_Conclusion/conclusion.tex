...
\begin{figure}[H]
	...
	\caption{Output from GL TIME ELAPSED per frame for a hybrid scene. Time is averaging around 42'000'000.}
...
\begin{figure}[H]
	...
	\caption{Output from GL TIME ELAPSED per frame for a purely rasterized scene. Time is averaging around 4'500'000.}
