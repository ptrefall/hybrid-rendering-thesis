...
Its the future. Hardware is becoming increasingly parallel. Ray tracing is trivially paralellizable. Ray tracing won't replace rasterization over night, but it will become an increasingly useful.

Its conceptually simpler. Shaders can be written with fewer dependencies. Tradeing memory and programmer time for compute power.
