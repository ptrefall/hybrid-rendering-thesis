...
/** 
 * 32-bit floating point complex number (32 bit real, 32 bit imaginary) in
 * place signal add product of signal times constant to destination signal.
 * \param pSrcDst \ref in_place_signal_pointer.
 * \param nValue Constant value to be multiplied by each vector element
 * \param nLength \ref length_specification.
 * \return \ref signal_data_error_codes, \ref length_error_codes.
 */
NppStatus 
nppsAddProductC_32fc_I(Npp32fc nValue, Npp32fc * pSrcDst, int nLength);

/** 
 * 32-bit floating point complex number (32 bit real, 32 bit imaginary)signal
 * add product of signal times constant to destination signal.
 * \param pSrc \ref source_signal_pointer.
 * \param nValue Constant value to be multiplied by each vector element
 * \param pDst \ref destination_signal_pointer.
 * \param nLength \ref length_specification.
 ...
 */
NppStatus 
nppsAddProductC_32fc(const Npp32fc * pSrc, Npp32fc nValue, Npp32fc * pDst, int nLength);

/** 
 * 64-bit floating point, in place signal add product of signal times constant to destination signal.
 * \param pSrcDst \ref in_place_signal_pointer.
 * \param nValue Constant value to be multiplied by each vector element
 * \param nLength Length of the vectors, number of items.
 * \return \ref signal_data_error_codes, \ref length_error_codes.
 */
NppStatus 
nppsAddProductC_64f_I(Npp64f nValue, Npp64f * pSrcDst, int nLength);

/** 
 * 64-bit floating point signal add product of signal times constant to destination signal.
 * \param pSrc \ref source_signal_pointer.
 * \param nValue Constant value to be multiplied by each vector element
 * \param pDst \ref destination_signal_pointer.
 * \param nLength \ref length_specification.
 ...
 */
NppStatus 
nppsAddProductC_64f(const Npp64f * pSrc, Npp64f nValue, Npp64f * pDst, int nLength);
 ...
 */
NppStatus 
nppsAddProductC_64fc_I(Npp64fc nValue, Npp64fc * pSrcDst, int nLength);
 ...
 */
NppStatus 
nppsAddProductC_64fc(const Npp64fc * pSrc, Npp64fc nValue, Npp64fc * pDst, int nLength);
...
/** 
 * Device scratch buffer size (in bytes) for 32f Sum.
...
/** 
 * Device scratch buffer size (in bytes) for 32f Max.
 * This primitive provides the correct buffer size for nppsMax_32f.
 * \param nLength \ref length_specification.
 * \param hpBufferSize Required buffer size. Important: hpBufferSize is a 
 *        <em>host pointer.</em> \ref general_scratch_buffer.
 * \return NPP_SUCCESS
...
/** 
 * Device scratch buffer size (in bytes) for 32f Min.
 * This primitive provides the correct buffer size for nppsMin_32f.
 * \param nLength \ref length_specification.
 * \param hpBufferSize Required buffer size. Important: hpBufferSize is a 
 *        <em>host pointer.</em> \ref general_scratch_buffer.
 * \return NPP_SUCCESS
...
/** 
 * Device scratch buffer size (in bytes) for 16s32s_Sfs.
 * This primitive provides the correct buffer size for nppsSum_16s32s_Sfs.
 * \param nLength \ref length_specification.
 * \param hpBufferSize Required buffer size. Important: hpBufferSize is a 
 *        <em>host pointer.</em> \ref general_scratch_buffer.
 * \return NPP_SUCCESS
...
/** 
 * Device scratch buffer size (in bytes) for 16s Max.
 * This primitive provides the correct buffer size for nppsMax_16s.
 * \param nLength \ref length_specification.
 * \param hpBufferSize Required buffer size. Important: hpBufferSize is a 
 *        <em>host pointer.</em> \ref general_scratch_buffer.
 * \return NPP_SUCCESS
...
/** 
 * Device scratch buffer size (in bytes) for 16s Min.
 * This primitive provides the correct buffer size for nppsMin_16s.
 * \param nLength \ref length_specification.
 * \param hpBufferSize Required buffer size. Important: hpBufferSize is a 
 *        <em>host pointer.</em> \ref general_scratch_buffer.
 * \return NPP_SUCCESS
...
/** 
 * Device scratch buffer size (in bytes) for 64fc Sum.
...
/** 
 * Device scratch buffer size (in bytes) for 16s_Sfs Sum.
...
/** 
 * Device scratch buffer size (in bytes) for 16sc_Sfs Sum.
...
/** 
 * Device scratch buffer size (in bytes) for 16sc32sc_Sfs Sum.
 * This primitive provides the correct buffer size for nppsSum_16sc32sc_Sfs.
 * \param nLength \ref length_specification.
 * \param hpBufferSize Required buffer size. Important: hpBufferSize is a 
 *        <em>host pointer.</em> \ref general_scratch_buffer.
 * \return NPP_SUCCESS
...
/** 
 * Device scratch buffer size (in bytes) for 64f Sum.
...
/** 
 * Device scratch buffer size (in bytes) for 64f Max.
 * This primitive provides the correct buffer size for nppsMax_64f.
 * \param nLength \ref length_specification.
 * \param hpBufferSize Required buffer size. Important: hpBufferSize is a 
 *        <em>host pointer.</em> \ref general_scratch_buffer.
 * \return NPP_SUCCESS
...
/** 
 * Device scratch buffer size (in bytes) for 64f Min.
 * This primitive provides the correct buffer size for nppsMin_64f.
 * \param nLength \ref length_specification.
 * \param hpBufferSize Required buffer size. Important: hpBufferSize is a 
 *        <em>host pointer.</em> \ref general_scratch_buffer.
 * \return NPP_SUCCESS
...
/** 
 * Device scratch buffer size (in bytes) for 32s_Sfs Sum.
...
/** 
 * Device scratch buffer size (in bytes) for 32s Max.
 * This primitive provides the correct buffer size for nppsMax_32s.
 * \param nLength \ref length_specification.
 * \param hpBufferSize Required buffer size. Important: hpBufferSize is a 
 *        <em>host pointer.</em> \ref general_scratch_buffer.
 * \return NPP_SUCCESS
...
/** 
 * Device scratch buffer size (in bytes) for 32s Min.
 * This primitive provides the correct buffer size for nppsMin_32s.
 * \param nLength \ref length_specification.
 * \param hpBufferSize Required buffer size. Important: hpBufferSize is a 
 *        <em>host pointer.</em> \ref general_scratch_buffer.
 * \return NPP_SUCCESS
...
/** 
 * Device scratch buffer size (in bytes) for 32fc Sum.
