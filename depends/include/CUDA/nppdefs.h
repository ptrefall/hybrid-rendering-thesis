...
typedef enum 
{
    ...
    NPP_WRONG_INTERSECTION_ROI_WARNING      = 29,       ///< ROI doesn't intersect source or destination ROI/image. No operation performed.
} NppStatus;
...
#define NPP_MIN_64S     (-9223372036854775807LL - 1)///< Maximum 64-bit signed integer
...
typedef enum  {
    NPP_BORDER_UNDEFINED        = -1,
    NPP_BORDER_NONE             = NPP_BORDER_UNDEFINED, 
    NPP_BORDER_CONSTANT         =  0,
